            ...
            <div class="modal-body">
                <form class="form-horizontal" id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input id="dateTime" type="datetime-local" value="${meal.dateTime}" name="dateTime" placeholder="<spring:message code="meal.dateTime"/>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input id="description" type="text" value="${meal.description}" size=40 name="description" placeholder="<spring:message code="meal.description"/>" required>
                        </div>
                    </div>
